...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 0.6.8 on Thu Oct 16 21:40:16 2014
#
...
class SendMessageInterface(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.btnEnableHost = wx.Button(self.nbpSend, wx.ID_ANY, u"\u041f\u043e\u0434\u043a\u043b\u044e\u0447\u0438\u0442\u044c")
        ...
        self.btnAddAllSendMessage = wx.Button(self.nbpSend, wx.ID_ANY, u"\u0414\u043e\u0431\u0430\u0432\u0438\u0442\u044c \u0432\u0441\u0435")
        ...
        self.btnEnableRcvPort = wx.Button(self.nbpReceive, wx.ID_ANY, u"\u041f\u043e\u0434\u043a\u043b\u044e\u0447\u0438\u0442\u044c")
        ...
        self.Bind(wx.EVT_BUTTON, self.btnEnableHost_on_click, self.btnEnableHost)
        ...
        self.Bind(wx.EVT_BUTTON, self.btnAddAllSendMessage_on_click, self.btnAddAllSendMessage)
        ...
        self.Bind(wx.EVT_BUTTON, self.btnEnableRcvPort_on_click, self.btnEnableRcvPort)
    ...
    def __do_layout(self):
        ...
        grid_sizer_5.Add(self.btnEnableHost, 0, wx.EXPAND, 0)
        ...
        grid_sizer_4.Add(self.btnAddAllSendMessage, 0, 0, 0)
        ...
        grid_sizer_7.Add(self.btnEnableRcvPort, 0, 0, 0)
    ...
    def btnEnableHost_on_click(self, event):  # wxGlade: SendMessageInterface.<event_handler>
        print "Event handler 'btnEnableHost_on_click' not implemented!"
        event.Skip()
    ...
    def btnAddAllSendMessage_on_click(self, event):  # wxGlade: SendMessageInterface.<event_handler>
        print "Event handler 'btnAddAllSendMessage_on_click' not implemented!"
        event.Skip()
    ...
    def btnEnableRcvPort_on_click(self, event):  # wxGlade: SendMessageInterface.<event_handler>
        print "Event handler 'btnEnableRcvPort_on_click' not implemented!"
        event.Skip()
